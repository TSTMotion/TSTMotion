...
SMPL_MODEL_DIR = "./datasets/"
GMM_MODEL_DIR = "./motion_latent_diffusion/visualize/joints2smpl/smpl_models/"
SMPL_MEAN_FILE = "./motion_latent_diffusion/visualize/joints2smpl/smpl_models/neutral_smpl_mean_params.h5"
# for collsion 
Part_Seg_DIR = "./motion_latent_diffusion/visualize/joints2smpl/smpl_models/smplx_parts_segm.pkl"