...
smplx_folder = './datasets/'
scan2cad_anno = '/home/wangzan/Data/scan2cad/scan2cad_download_link/full_annotations.json'
scannet_folder = '/ScanNet_v2_raw/scans/'
referit3d_sr3d = '/home/wangzan/Data/referit3d/sr3d.csv'

pure_motion_folder = '/home/guoziyan/project/HUMANISE/dataset_download/HUMANISE/pure_motion/'
align_data_folder = '/home/guoziyan/project/HUMANISE/dataset_download/HUMANISE/align_data_release/'
preprocess_scene_folder = '/home/guoziyan/project/HUMANISE/dataset_download/scannet_scenes/'
...
def parse_args():
    ...
    parser.add_argument('--val_dir', 
                        type=str, 
                        default='./datasets/HUMANISE_val.pkl',
